...
extension TagDtoQueryWhere on QueryBuilder<TagDto, TagDto, QWhereClause> {
  ...
  QueryBuilder<TagDto, TagDto, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TagDto, TagDto, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TagDtoQueryFilter on QueryBuilder<TagDto, TagDto, QFilterCondition> {
  ...
  QueryBuilder<TagDto, TagDto, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TagDto, TagDto, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension TagDtoQueryProperty on QueryBuilder<TagDto, TagDto, QQueryProperty> {
  ...
  QueryBuilder<TagDto, TagColor, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
